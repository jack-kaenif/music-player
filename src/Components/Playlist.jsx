      ...
      <div style={playlistStyles.header}>
        ...
        <div style={playlistStyles.controls}>
          <button
            ...
            onClick={() =>
              handleSort(sortOrder === "title-asc" ? "title-desc" : "title-asc")
            }
            onMouseOver={(e) =>
              (e.currentTarget.style.backgroundColor =
                playlistStyles.sortButtonHover.backgroundColor)
            }
            onMouseOut={(e) =>
              (e.currentTarget.style.backgroundColor =
          ...
          <button
            ...
            onMouseOver={(e) =>
              (e.currentTarget.style.backgroundColor =
                playlistStyles.buttonHover.backgroundColor)
            }
            onMouseOut={(e) =>
              (e.currentTarget.style.backgroundColor =
                playlistStyles.button.background)
            }
          >
            <Trash2 size={20} />
          </button>
